...
class TestMethodId(object):
    def test_eq(self):
        truth = MethodId(
            0x0A, -1, "Ljava/lang/Object;", "toString", "()Ljava/lang/String;"
        )
...
class TestApkinfo(object):
    ...
    def test_dex_list(self, apkinfo_obj):
        ...
        truth = {"classes.dex": "ca8bcc8db3963fd1935b21009bcaa717"}
    ...
    def test_find_method_by_addr(self, apkinfo_obj):
        ...
        # API functions
        assert apkinfo_obj.find_methods_by_addr(0, 0x6DB0) == MethodId(
            0x6D98,
            0,
        ...
        assert apkinfo_obj.find_methods_by_addr(0, 0xE758) == MethodId(
            0xE758,
            0,
            "Lcom/ku6/android/videobrowser/Search_Activity;",
            "search",
            "(Ljava/lang/String;)V",
        )
    ...
    def test_get_all_methods_structured(self, apkinfo_obj):
        truths = [
            MethodId(
                0x883C,
                0,
                "Lcom/ku6/android/videobrowser/About_Activity$1;",
                "<init>",
                "(Lcom/ku6/android/videobrowser/About_Activity;)V",
            ),
            MethodId(
                0x8858,
                0,
            ...
            MethodId(
                0x88AC,
                0,
                "Lcom/ku6/android/videobrowser/Base_Activity;",
                "<init>",
                "()V",
            ),
            MethodId(
        ...
        for truth in truths:
            assert (
                truth
                in apkinfo_obj.get_all_methods_classified(0)[truth.classname]
            )
    ...
    def test_find_methods(self, apkinfo_obj):
        ...
        assert set(result) == set(
            (
                MethodId(0x6DA8, -1, "Ljava/util/ArrayList;", "<init>", "()V"),
                MethodId(
                    0x6DB0,
                    -1,
                    "Ljava/util/ArrayList;",
                ...
                MethodId(0x6DC0, -1, "Ljava/util/ArrayList;", "clear", "()V"),
                MethodId(
                    0x6DC8,
                    -1,
                    "Ljava/util/ArrayList;",
    ...
    def test_find_upper_functions(self, apkinfo_obj):
        # API functions
        method = MethodId(
            0x6C98, 0, "Ljava/lang/String;", "length", "()I", True
        )
        ...
        assert set(apkinfo_obj.find_upper_methods(method)) == {
            ...
            (
                ...
                MethodId(
                    0xF0B0,
                    0,
                    "Lcom/ku6/android/videobrowser/Search_Result_Activity;",
                    "setSearchKeyword",
                    "(Ljava/lang/String;)V",
                ),
            ),
            (
                ...
                MethodId(
                    0x10A48,
                    0,
                    "Lcom/ku6/android/videobrowser/SplashActivity;",
                    "getDataSource",
                    "(Lcom/ku6/android/videobrowser/entity/Version;)V",
                ),
            ),
        }
        ...
        assert set(apkinfo_obj.find_upper_methods(method)) == {
            (
                ...
                MethodId(
                    0xDDCC,
                    0,
                    "Lcom/ku6/android/videobrowser/Search_Activity$4;",
                    "onItemClick",
    ...
    def test_get_function_bytecode(self, apkinfo_obj):
        ...
        assert [bytecode for bytecode in bytecode_list] == [
            Bytecode(
                0x8ABC, "new-instance", [0], "Landroid/app/ProgressDialog;"
            ),
            Bytecode(
                0x8AC0,
                "invoke-direct",
        ...
        assert [bytecode for bytecode in bytecode_list] == [
            Bytecode(
                ...
                "iget-object",
                [0, 1],
                "Lcom/ku6/android/videobrowser/ChannelDetailAdapter;->coll Ljava/util/ArrayList;",
            ),
            Bytecode(
                0x9950,
                "invoke-virtual",
