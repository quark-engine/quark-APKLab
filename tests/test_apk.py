...
class TestMethodId(object):
    ...
    def test_eq(self):
        truth = MethodId(0x0A, 'Ljava/lang/Object',
                         'toString', '()Ljava/lang/String;')

        assert MethodId(0x0A, 'Ljava/lang/Object', 'toString',
                        '()Ljava/lang/String;') == truth

        assert MethodId(0x0B, 'Ljava/lang/Object', 'toString',
                        '()Ljava/lang/String;') != truth
        assert MethodId(0x0A, 'Ljava/lang/String', 'toString',
                        '()Ljava/lang/String;') != truth
        assert MethodId(0x0A, 'Ljava/lang/Object', 'asString',
                        '()Ljava/lang/String;') != truth
        assert MethodId(0x0A, 'Ljava/lang/Object', 'toString',
                        '()Ljava/lang/Object;') != truth

    def test_hash(self):
        assert hash(MethodId(0x0A, 'Ljava/lang/Object', 'toString', '()Ljava/lang/String;')
                    ) == hash(MethodId(0x0A, 'Ljava/lang/Object', 'toString', '()Ljava/lang/String;'))
...
class TestApkinfo(object):
    ...
    def test_find_methods(self, apkinfo_obj):
        ...
        assert set(result) == set((
            MethodId(0x6DB0, 'Ljava/util/ArrayList', 'add', '(Ljava/lang/Object;)Z'),))
        ...
        assert set(result) == set((MethodId(0x48B0, 'Landroid/app/AlertDialog$Builder', 'setNegativeButton',
        ...
        assert set(result) == set((MethodId(0x6DA8, 'Ljava/util/ArrayList', '<init>', '()V'),
                                   MethodId(0x6DB0, 'Ljava/util/ArrayList',
                                            'add', '(Ljava/lang/Object;)Z'),
                                   MethodId(0x6DB8, 'Ljava/util/ArrayList',
                                            'addAll', '(Ljava/util/Collection;)Z'),
                                   MethodId(
            0x6DC0, 'Ljava/util/ArrayList', 'clear', '()V'),
            MethodId(0x6DC8, 'Ljava/util/ArrayList',
                     'get', '(I)Ljava/lang/Object;'),
            MethodId(0x6DD0, 'Ljava/util/ArrayList',
                     'remove', '(I)Ljava/lang/Object;'),
            MethodId(0x6DD8, 'Ljava/util/ArrayList', 'size', '()I')))

        result = apkinfo_obj.find_methods(methodname='add')
        assert set(result) == set((
            MethodId(0x4C40, 'Landroid/view/Menu', 'add',
                     '(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;'),
            MethodId(0x6DB0, 'Ljava/util/ArrayList',
                     'add', '(Ljava/lang/Object;)Z'),
            MethodId(0x6E20, 'Ljava/util/List',
                     'add', '(Ljava/lang/Object;)Z'),
            MethodId(0x6E70, 'Ljava/util/Vector',
                     'add', '(Ljava/lang/Object;)Z')
        ))
